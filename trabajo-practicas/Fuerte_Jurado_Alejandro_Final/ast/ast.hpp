...
/*!	
  \class   DoStmt
  \brief   Definition of atributes and methods of DoStmt class
  \note    DoStmt Class publicly inherits from Statement class 
		   and adds its own print and evaluate functions
*/
