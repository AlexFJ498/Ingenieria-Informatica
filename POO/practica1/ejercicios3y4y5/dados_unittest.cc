...
TEST(Dados, getLanzamiento) {
  ...
  d.setDado2(2);
  d.lanzamiento();
  EXPECT_EQ(2, d.getLanzamiento1());
  EXPECT_EQ(2, d.getLanzamiento2());
  for (int i=0;i<5;i++) d.setDado1(4);
  for (int i=0;i<10;i++) d.setDado2(4);
  EXPECT_EQ(7, d.getLanzamiento1());
  EXPECT_EQ(12, d.getLanzamiento2());
}
